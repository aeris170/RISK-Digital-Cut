		...
		if (isEnabled && DoaMouse.MB1) {
			if (click) {
				if (firstColorHitBox().contains(DoaMouse.X, DoaMouse.Y)
						&& COMBO_BUTTONS.stream().filter(cb -> cb != this).allMatch(cb -> cb.index != 0)) {
					index = 0;
				} else if (secondColorHitBox().contains(DoaMouse.X, DoaMouse.Y)
						&& COMBO_BUTTONS.stream().filter(cb -> cb != this).allMatch(cb -> cb.index != 1)) {
					index = 1;
				} else if (thirdColorHitBox().contains(DoaMouse.X, DoaMouse.Y)
						&& COMBO_BUTTONS.stream().filter(cb -> cb != this).allMatch(cb -> cb.index != 2)) {
					index = 2;
				} else if (fourthColorHitBox().contains(DoaMouse.X, DoaMouse.Y)
						&& COMBO_BUTTONS.stream().filter(cb -> cb != this).allMatch(cb -> cb.index != 3)) {
					index = 3;
				} else if (fifthColorHitBox().contains(DoaMouse.X, DoaMouse.Y)
						&& COMBO_BUTTONS.stream().filter(cb -> cb != this).allMatch(cb -> cb.index != 4)) {
					index = 4;
				} else if (sixthColorHitBox().contains(DoaMouse.X, DoaMouse.Y)
						&& COMBO_BUTTONS.stream().filter(cb -> cb != this).allMatch(cb -> cb.index != 5)) {
					index = 5;
				}
				click = false;
