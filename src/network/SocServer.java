...
public class SocServer extends JFrame{
	...
	public void startRunning(){
		try{
			server = new ServerSocket(9876); //port number is 6789
	...
	private void waitForConnection() throws IOException{
		...
		connection = server.accept(); //do it this over and over again and someone really connected the connection is made
	...
	/**
	 * Description: When the user enter text into serverText this will take the text and send it to client via sendMessage method 
	 * @author EgeTuran
	 */
